...
//    }
    ...
    // 将两个字符串做异或
    public static byte[] twoStringXor(String str1, String str2) {
        ...
        for (int i = 0; i < longbytes.length; i++){
            xorstr[i] = (byte)(shortbytes[i % shortbytes.length] ^ longbytes[i]);
        }
        return xorstr;
    }
    ...
    /**
     *
     * @param originBytes 原始字符串
     * @param xorBytes 异或串
     * @return
     */
    public static byte[] twoStringXorReverse(byte[] originBytes, byte[] xorBytes) {
        byte[] bytes = new byte[originBytes.length];
        for (int i = 0; i < originBytes.length; i++){
            bytes[i] = (byte)(xorBytes[i % xorBytes.length] ^ originBytes.length);
        }
        return bytes;
    }
     ...
     * @return
     */
    public static String extendStrto32Lenth(String str){
        char[] chars = new char[32];
        for (int i = 0; i < chars.length; i++) {
            chars[i] = str.charAt(i % str.length());
        }
     ...
     * @return
     */
    public static String split64to32(String str){
